...
IDtable=read.csv("your_blasthits_file",sep='\t',header=F,as.is=TRUE)
...
#Include evaluation (and taxonomic string) of all hits down to 20% below max. For similarity level analyses.
#my_clasified_result <- assign_taxonomy(IDtable,upper_margin = 20, lower_margin = 20, remove = c("uncultured","environmental"))
